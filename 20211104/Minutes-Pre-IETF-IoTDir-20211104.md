...
Hannes: manifest was cut down on functionality. Spec only contains core pieces. Extensions to separate doc. Done to make the whole spec simpler to read. Had hackathon this week. Will see if people like the cleaned-up version. Progress on FW encryption mech; turned out to be more complicated than thought. Have published draft on this. Russ will talk about next week.

TEEP (Tiru Reddy / Nancy Cam-Winget)
T2TRG (Ari Keränen / Carsten Bormann)
Done:

Summary interim meeting last week
...
Since last IETF, had two WISHI meetings on SDF architectural topics and Azure DTDL — SDF interwork topic
Next:

RG draft on “IoT Edge Challenges and functions” going soon for RG LC
